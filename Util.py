...
def notifyBySMS(content):
    ssender = SmsSingleSender('1400167402', 'b09bfd657a9e28d7fc7d5eab361e49bf')
    params = [content]  # 当模板没有参数时，`params = []`，数组具体的元素个数和模板中变量个数必须一致，例如事例中templateId:5678对应一个变量，参数数组中元素个数也必须是一个
    try:
        result = ssender.send_with_param(86, '13268108673', '243989', params, extend="", ext="")  # 签名参数未提供或者为空时，会使用默认签名发送短信
